...
export class StorageManager {
    ...
    private KEY_CONFIG: string = Constants.GAME_NAME;
    ...
    start () {
        ...
        //     let newContent = new Xxtea("upgradeHeroAbility").xxteaDecrypt(content);
     ...
     * @param {any}value  存储值
     */
    public setConfigDataWithoutSave (key: string, value: any) {
