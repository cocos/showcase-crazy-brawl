...
export class AudioManager {
    ...
    public playWeaponSound (weapon: string) {
        if (!this.dictWeaponSoundIndex[weapon]) {
            this.dictWeaponSoundIndex[weapon] = 1;
        } else {
            this.dictWeaponSoundIndex[weapon] = this.dictWeaponSoundIndex[weapon] === 1 ? 2 : 1;
        }

        this.playSound(`${weapon}_${this.dictWeaponSoundIndex[weapon]}`);
    }
}
